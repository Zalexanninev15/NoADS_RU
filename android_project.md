...
> [!TIP]
> По поводу Spotify: Также рекомендую попробовать использовать браузерную версию или Spotifuck, если после применения модуля у вас возникли проблемы, т.к. оригиналом пользоваться то ещё удовольствие после последних обновлений.
