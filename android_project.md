...
> [!TIP]
> По поводу Spotify: Также рекомендую попробовать использовать браузерную версию или [Spotishka Web by Oleg Aprel](https://t.me/olegaprel/3409) (на крайний - Spotifuck), если после применения модуля у вас возникли проблемы, т.к. оригиналом пользоваться то ещё удовольствие после последних обновлений, а веб-версия пока ещё держится, особенно со сторонними скриптами и CSS.
