...
> [!NOTE]
> Список составлен из личных Telegram каналов и Telegram каналов знакомых при помощи моего скрипта **TG AntiK** из репозитория [TgStuff](https://codeberg.org/Zalexanninev15/TgStuff). Список является субъективным и вы вольны не соглашаться, однако, как минимум, стоит хотя бы принять во внимание.

> [!TIP]
> Ссылки расположены в формате удобном для открытия в браузере. Чтобы использовать для иных целей - выполните замену в файле `/s/` на `/`.
