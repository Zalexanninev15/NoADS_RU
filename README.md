...
Нажмите на [это](https://subscribe.adblockplus.org/?location=https://raw.githubusercontent.com/Zalexanninev15/NoADS_RU/master/ads_list.txt&title=NoADS_RU) и согласитесь на добавление в плагин (нажмите ОК на всех всплывающих сообщениях при подключении списка к плагину). Елси откроется вкладка с возможностью "подписаться" на список (в новых версиях uBlock Origin), то смело нажимаете на кнопку "Подписаться"
