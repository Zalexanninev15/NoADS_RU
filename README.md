...
| --- | --- | --- |
| 👍 **NoADS_RU** | Full | Основной проект репозитория. |
| ⚡ **NoADS_RU Extended** | Full | Расширенный список фильтров на базе NoADS_RU. |
| 💪 **NoADS_RU Extended Plus** | Full | Расширенный список фильтров на базе NoADS_RU Extended. |
| 🇷🇺 **NoADS_RU RWS** | Full | Список фильтров для 100% работы Я*, MAX, ВКонтакте (и, возможно, других русскоязычных сервисов) на базе NoADS_RU. |
| 📹 **NoADS_RU YouTube** | Add-on | Фильтры конкретно для YouTube. |
| 🤖🖼️❌ **NoADS_RU AI Slop Killer** | Add-on | Блокировка ИИ и сгенерированного низкокачественного контента. |
| 👨‍💻 **NoADS_RU Faust** | Add-on | Фильтры от Faust'а. |
