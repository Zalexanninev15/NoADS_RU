...
- [ ] Хотелось бы попасть на сайт filterlists.com. Буду рад, если [подсобите](https://github.com/collinbarrett/FilterLists) 🙏
...
- [ ] Переработка и актуализация информации касаемо NoADS_RU Web Unlimited. Отлжено на неопределённый срок в связи с нестабильной обстановкой и *их* возможностями заблокировать всё и вся.
...
* Vivaldi 🦖
* Brave 🦖
* Браузеры, которые имеют встроенный AdBlock с поддержкой пользовательских списков фильтров
