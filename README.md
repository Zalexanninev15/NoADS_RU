...
## NoADS_RU Evil (E/EE/EPE)

Списки фильтров, в которых автор сделал некоторые послабления в плане блокировки доменов и аргументов для сайтов (доступен тот же *max.ru*, выполнение скриптов VK API и Yandex API). В **NoADS_RU Extended Evil** и **NoADS_RU Extended Plus Evil** работают также панели в Google сервисах (что за панели: [сервисы гугла](https://anishark.mooo.com/files/8e4e356e-4ab8-482f-855c-10daf5225b9f.webp) и [смена аккаунта](https://anishark.mooo.com/files/cba60236-2a74-4212-88d1-91547da37122.webp)), которые работают как в обычном **NoADS_RU**, так и в **NoADS_RU Evil**. Данные списки фильтров будут расширяться не так часто.

> Для использования возьмите любой список фильтров и после `main/` добавьте `evil/`, чтобы получилось в итоге `main/evil/`.
