...
- [ ] Исправление [проблем с сервисами Я*](https://github.com/Zalexanninev15/NoADS_RU/issues/47)
...
Upd. Временно отложено, т.к. слишком много обращений "посыплется" на голову автора репозитория.
