...
> [!IMPORTANT]
> С 4 января автор уходит в отпуск и обновлений проектов NoADS_RU не будет до 16 февраля. Обращения рассматриваться не будут, однако все слияния из форков будут проверяться и добавляться в репозиторий.
...
🧨 Подкину парочку **интересных** проектов, но не говорите товарищу 👮🤫: [тык 1](https://github.com/igareck/vpn-configs-for-russia), [тык 2](https://github.com/AvenCores/goida-vpn-configs), [тык 3](https://github.com/zieng2/wl). Уж очень [интересный списочек белоснежных сервисов ~~можна для SNI~~](https://api.lightbilling.cloud/static/library/skat/white.txt) (в основном, банки).

Наш один знакомый [🐊🛩️](https://t.me/airfield1972) [кликабельны] (пора бы уже обзавестись основным аэродромом 😉) очень стараяется для всех! Низкий поклон ему 🙇

🎁 Обход ограничений мобильного интернета на 100% — [@oversecure](https://t.me/oversecure) и [полезная информация для понимания ситуации и возможностей обхода ограничений](https://github.com/hxehex/russia-mobile-internet-whitelist). Крупная тема на синем форуме - [«Суверенный Интернет» (обсуждение и решение проблемы)](https://4pda.to/forum/index.php?showtopic=1110469&view=findpost&p=139502832), а также [Дайджест программ VPN для Android OS и Windows](https://4pda.to/forum/index.php?showtopic=1088387), [VPN Club](https://4pda.to/forum/index.php?showtopic=928862), [Способы обходов блокировок на прошивке OpenWrt](https://4pda.to/forum/index.php?showtopic=1085698). [Выбор площадки для аренды VPS](https://4pda.to/forum/index.php?showtopic=1082943) (можно для VPN). Самое интересное в [Трепалка VPN](https://4pda.to/forum/index.php?showforum=1196) (все ссылки на синий форум доступны только вне Р*)
...
> [!TIP]
> Можно использовать сокращённые названия:
> - `UB` - NoADS_RU
...
6. Если что-то не работает, то также может помочь переподключение списка в настройках блокировщика или выбор более простого варианта списка (НЕ Extended). Если это хосты, то подойдёт более простой [Блокировщик](https://raw.githubusercontent.com/Zalexanninev15/NoADS_RU/main/hosts/blocker.txt).
...
---
📨 [Альтернативный канал связи через Delta Chat](https://i.delta.chat/#DF589D9559E50B3A54B6A57D11B28CC0203FE0C0&a=f7ssxgexw%40nine.testrun.org&g=Chat%20X&x=jDls0FWxNqMUfZmg3p-lBJdl&i=mKm7--PY-OniYgAsaCjTLcUv&s=Xu1fnVOyih7THA5hKfd9foeD) (правила не такие строгие, но вариант с обращением на GitHub предпочтительнее)
