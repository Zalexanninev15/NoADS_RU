...
4. Перед отправкой обращения рекомендуется самостоятельно идентифицировать причину поломки (приложите конкретный фильтр или домен, который ломает работу сайта), чтобы автору было проще внедрить исправление.
