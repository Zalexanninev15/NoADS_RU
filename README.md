...
💪 Для особых ценителей создан новый список [NoADS_RU Extended Plus](https://raw.githubusercontent.com/Zalexanninev15/NoADS_RU/main/ads_list_extended.txt), который включает в себя какое-то немыслимое количество правил. Данный список автор не использует у себя в качестве основного, т.к. список слишком обширный (105k строк, Карл!), использовать рекомендуется только совсем "достала" реклама или как средство для тотальной блокировки всего что движется или мешает вашему времяпрепровождению в Интернете.
