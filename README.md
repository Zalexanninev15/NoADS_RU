...
- [ ] Задача #87
- [ ] Интеграция списка каналов на ютубе, которые выкладывают нейропомойный контент ([источник](https://github.com/Override92/AiSList)) в список фильтров *NoADS_RU AI Slop Killer*  для автоматической блокировки при поиске (в теории)
