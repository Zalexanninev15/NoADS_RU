...
Дополнительно (для Варианта 2): Если у вас при нажатии на ссылку откроется новая вкладка, то закройте её, перезагрузите данную страницу и нажмите на ссылку вновь
