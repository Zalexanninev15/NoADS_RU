...
> Также проектом **NoADS_RU** развиваются расширенные списки (**NoADS_RU Extended** и **NoADS_RU Extended Plus**), списки хостов (**NoADS_RU Hosts**), блокировка рекламы на Android (**NoADS_RU Android Project**) и списки .
...
[Перейти в Android Project](https://github.com/Zalexanninev15/NoADS_RU/tree/main/android.md)
